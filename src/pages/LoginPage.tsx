...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // The AppContext creates a demo user name from the email
      // when the email is not already present in sampleUsers.
      login(enteredEmail, role);
  ...
  const handleDemoLogin = (demoRole: UserRole, demoEmail: string) => {
    ...
    setTimeout(() => {
      // Quick Demo Login intentionally uses the predefined sample users.
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div>
            ...
            <p className="text-eco-50 mt-4 text-lg leading-relaxed max-w-md">
              Join the movement. Schedule pickups, earn rewards, and make a
          ...
          <p className="text-sm text-eco-100">
            © 2025 EcoNex. Connecting Waste to Worth.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-sm text-slate-500 mt-1">
            Login to your EcoNex account to continue.
          </p>
          ...
          <form onSubmit={handleLogin} className="mt-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-sm text-eco-600 font-medium hover:underline"
              >
                Forgot password?
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {demoCreds.map((cred) => (
                <button
                  ...
                  type="button"
                  onClick={() =>
                    handleDemoLogin(cred.role, cred.email)
                  }
                  disabled={loading}
